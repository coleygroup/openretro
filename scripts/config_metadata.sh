...
# paths for localretro
PROCESSED_DATA_PATH_LOCALRETRO=$PWD/data/USPTO_50k/processed_localretro
MODEL_PATH_LOCALRETRO=$PWD/checkpoints/USPTO_50k_localretro
TEST_OUTPUT_PATH_LOCALRETRO=$PWD/results/USPTO_50k_localretro

# paths for retrocomposer
PROCESSED_DATA_PATH_RETROCOMPOSER=$PWD/data/USPTO_50k/processed_retrocomposer
MODEL_PATH_RETROCOMPOSER=$PWD/checkpoints/USPTO_50k_retrocomposer
TEST_OUTPUT_PATH_RETROCOMPOSER=$PWD/results/USPTO_50k_retrocomposer
...
export PROCESSED_DATA_PATH_LOCALRETRO MODEL_PATH_LOCALRETRO TEST_OUTPUT_PATH_LOCALRETRO
export PROCESSED_DATA_PATH_RETROCOMPOSER MODEL_PATH_RETROCOMPOSER TEST_OUTPUT_PATH_RETROCOMPOSER
