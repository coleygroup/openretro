...
from models.retroxpert_model.util.rdchiral.template_extractor import extract_from_reaction

# comment out so that these codes won't be run at import time, by ztu 210120
"""
